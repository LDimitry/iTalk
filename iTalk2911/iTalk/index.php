...
<main>
    <div class="content">
        ...
        <div class="right">
            <img src="imgs/1.jpg" alt="" width="450" height="300">
        </div>
    </div>

    <section class="glass-section">
        <div class="glass-left">
            <img src="imgs/222.jpg" alt="Logo iTalk" width="350" height="400">
        </div>
    ...
    <div class="cards-container">
        <div class="card">
            <a href="dicas.php">
                <img src="imgs/Bandeira - EUA.png" alt="Bandeira do Reino Unido">
                <p>Inglês – Língua mais estudada globalmente.</p>
            </a>
        </div>
        <div class="card">
            <a href="dicas.php">
                <img src="imgs/Bandeira - Espanhol.png" alt="Bandeira da Espanha">
                <p>Espanhol – Popular na Europa e América.</p>
            </a>
        </div>
        <div class="card">
            <a href="dicas.php">
                <img src="imgs/Bandeira - Françes.png" alt="Bandeira da França">
                <p>Francês – Importância histórica e cultural.</p>
            </a>
        </div>
        <div class="card">
            <a href="dicas.php">
                <img src="imgs/Bandeira - Alemão.png" alt="Bandeira da Alemanha">
                <p>Alemão – Procurado em negócios e academia.</p>
            </a>
        </div>
        <div class="card">
            <a href="dicas.php">
                <img src="imgs/Bandeira - brasil.png" alt="Bandeira do Brasil">
    ...
    <div class="discover-image">
        <img src="imgs/333.jpg" alt="Imagem representando benefícios de aprender idiomas">
    </div>
</section>
